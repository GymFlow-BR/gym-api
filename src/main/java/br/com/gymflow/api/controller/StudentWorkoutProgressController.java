...
public class StudentWorkoutProgressController {
    ...
    @PatchMapping("/current/exercises/{workoutExerciseId}/complete")
    public ResponseEntity<StudentWorkoutExerciseProgressResponse> completeCurrentExercise(
    ...
    @PatchMapping("/current/exercises/{workoutExerciseId}/uncomplete")
    public ResponseEntity<StudentWorkoutExerciseProgressResponse> uncompleteCurrentExercise(
            @PathVariable Long studentId,
            @PathVariable Long workoutExerciseId
    ) {
        StudentWorkoutExerciseProgressResponse response =
    ...
    @PatchMapping("/{studentWorkoutId}/exercises/{workoutExerciseId}/complete")
    ...
    @PatchMapping("/{studentWorkoutId}/exercises/{workoutExerciseId}/uncomplete")
    ...
    @GetMapping("/{studentWorkoutId}/progress")
    public ResponseEntity<StudentCurrentWorkoutProgressResponse> getWorkoutProgress(
            @PathVariable Long studentId,
            @PathVariable Long studentWorkoutId
    ) {
        StudentCurrentWorkoutProgressResponse response =
                studentWorkoutProgressService.getWorkoutProgress(
                        studentId,
                        studentWorkoutId
                );
